...
__all__ = ("KubeBatchClusterConfig", "KubeBatchBackend", "KubeBatchBackendAndControllerMixin")


class KubeBatchClusterConfig(ClusterConfig):
    ...
    worker_extra_container_config = Dict(
        ...
        .. code::
            ...
            c.KubeBatchClusterConfig.worker_extra_container_config = {
                "envFrom": [
    ...
    worker_extra_pod_config = Dict(
        ...
        .. code::
            ...
            c.KubeBatchClusterConfig.worker_extra_pod_config = {
                "tolerations": [
                    {
                        "key": "key",
                        "operator": "Equal",
...
class KubeBatchBackendAndControllerMixin(LoggingConfigurable):
    ...
    def _default_instance(self):
        ...
        if not instance:
            raise ValueError("Must specify `c.KubeBatchBackend.instance`")
        return instance
...
class KubeBatchBackend(KubeBatchBackendAndControllerMixin, Backend):
    """A dask-gateway backend for running on Kubernetes"""

    cluster_config_class = Type(
        "dask_gateway_server.backends.kubernetes.backend.KubeBatchClusterConfig",
